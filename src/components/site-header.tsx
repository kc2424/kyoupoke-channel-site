...
// ヒーローの上では透明のまま。少しでもスクロールしたら白の下地を敷く。
// 実績(黒)・リンク(オレンジ)セクションの上でもナビが読めるようにするための処置で、
// 以前使っていた白いtext-shadowのグローは不要になったため廃止した。
  ...
  return (
    <header
      className={cn(
        ...
        scrolled
          ? "border-b border-neutral-200/60 bg-white/85 backdrop-blur-md"
