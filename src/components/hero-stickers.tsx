...
export function HeroStickers() {
  return (
    ...
    >
      ...
      <motion.div
        className="pointer-events-auto absolute right-[7%] sm:right-[14%] bottom-[46%] sm:bottom-[10%]"
      ...
      <motion.div
        className="pointer-events-auto absolute bottom-[51%] left-[3%] sm:left-[13%] sm:bottom-[8%]"
