...
const fallbackArticles: NewsArticle[] = [
  ...
  {
    slug: "kyoupoke-reject-partnership-2026",
    date: "2026-08-20",
    category: "お知らせ",
    title: "今日ポケ、REJECTとのパートナーシップを発表",
    summary:
      "REJECT公式プレスリリースおよび今日ポケ公式Xにて、今日ポケch.とREJECTのパートナーシップが発表されました。あわせてコラボアイテム「KYOUPOKE×REJECT TEE」の販売も開始されています。",
    body: [
      "REJECT公式のプレスリリースにて、今日ポケch.とREJECTのパートナーシップが発表されました。同リリースでは、コラボアイテム「KYOUPOKE×REJECT TEE」の販売開始もあわせて案内されています。",
      "今日ポケ公式Xでも同日、この提携について告知がありました。詳細な提携内容や商品情報など最新の一次情報は、必ず公式の発表をご確認ください。",
      "本サイトは非公式のファンサイトのため、掲載内容は公式発表を要約したものです。最新情報や変更点については公式の告知が優先されます。",
    ],
    link: {
      label: "今日ポケ公式Xで詳細を見る",
      href: "https://x.com/kyoupokech/status/2090426685766406337",
    },
  },
  {
    slug: "reject-cup-kuroko-team-victory-2026",
    date: "2026-08-20",
    category: "イベント",
    title: "REJECT杯、チームくろこが優勝「はじまりの王者」獲得",
    summary:
      "「Pokémon Champions はじまりの王者決定戦 REJECT杯」の結果が今日ポケ公式Xより報告され、チームくろこが優勝し「はじまりの王者」の称号を獲得しました。",
    body: [
      "今日ポケ公式Xより、「Pokémon Champions はじまりの王者決定戦 REJECT杯」の結果報告がありました。チームくろこ（くろこ・一条莉々華・たきしまの3名）が優勝し、「はじまりの王者」の称号を獲得したとのことです。",
      "大会は4チーム・総勢12名で行われましたが、決勝の対戦相手や各試合のスコア、優勝までの対戦順、個人成績など詳細な結果は公開情報からは確認できないため、本記事には含めていません。最新かつ詳しい情報は公式の発表をご確認ください。",
      "本サイトは非公式のファンサイトのため、掲載内容は公式発表を要約したものです。最新情報や変更点については公式の告知が優先されます。",
    ],
  },
];
